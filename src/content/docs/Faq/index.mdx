...
---
import {LinkButton, Card, CardGrid, Aside, LinkCard } from '@astrojs/starlight/components';
...
<details> 
    ...
    Contact us via any of the method listed in [this page](https://www.asop.asia/social.html). 
...
<details>
    <summary id="company-time">See our Company Opening time.</summary>
    M
</details>
