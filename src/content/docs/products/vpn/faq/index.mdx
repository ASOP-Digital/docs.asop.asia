...
<details>
    ...
    - please fill out [This form](https://url.asop.asia/services/vpn/form.html)
        - you will receive an message with the invoice and payment details, via your preferred contact method.

</details>

<details>
    <summary id="custom-plan-pricing"> How does our custom plan work? </summary>
    - every user will get `100GB / month` and `25 mbps` and `1 serect key` as a base plan (bronze plan). 
    The following are the prices for how much you want to add to your base plan:
        - Start with 2500 kyat.
        - Every `50 GB` = `1375 kyat`.
        - Every `5 mbps` = `1000 kyat`.
        - Every `1 serect key` = `2500 kyat`
    - For Custom pricing, please contact us. We may give discounts if plans are bought in bulk,
        - eg, more than 2000 GB / month or more than 100 mbps or more than 10 serect keys.
</details>
...
<details>
    ...
    Yes we offer dedicated customer service for B3 or higher plans.
